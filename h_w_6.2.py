...
seconds_list = [0, 224930, 466289, 950400, 1209600, 1900800, 8639999, 22493, 7948799]
...
for seconds in seconds_list:
    ...
    # простое слово для дней (можно оставить "днів" всегда)
    print(days, "днів,", str(hours).zfill(2) + ":" + str(minutes).zfill(2) + ":" + str(seconds).zfill(2))
